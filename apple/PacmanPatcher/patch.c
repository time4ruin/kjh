...
#define MACOS_VERSION "14.6.1"
#define NAME_STRING_ORIGINAL    "root:xnu-10063.141.2~1/DEVELOPMENT_ARM64_T"
#define NAME_STRING_NEW         "root:xnu-10063.141.2~1/PACMANPATCH_ARM64_T"
