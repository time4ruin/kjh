...
int tests()
{
    ...
    double mean22 = trimmed_mean(h2m2, testsize, 0);
    double mean13 = trimmed_mean(h1m3, testsize, 0);
    double mean04 = trimmed_mean(h0m4, testsize, 0);
    double stddev40 = trimmed_stddev(h4m0, testsize, 0);
    double stddev31 = trimmed_stddev(h3m1, testsize, 0);
    double stddev22 = trimmed_stddev(h2m2, testsize, 0);
    double stddev13 = trimmed_stddev(h1m3, testsize, 0);
    double stddev04 = trimmed_stddev(h0m4, testsize, 0);
